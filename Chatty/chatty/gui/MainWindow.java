...
public class MainWindow extends JFrame 
		implements ChatInstance, ActionListener, WindowListener {

    private NetHandler nethandler;
    private JMenuItem miConnect, miDisconnect, miExit, miAbout, 
		miStartServer, miStopServer;
    ...
    public void setConnected(boolean connected) {
    	if (connected) {
    		setTitle("Chatty - Verbunden");
    		tfIn.requestFocus();
    	}
		else {
			setTitle("Chatty - Nicht verbunden");
		}
    	bSend.setEnabled(connected);
    }
    ...
    public void actionPerformed(ActionEvent event) {
    	...
    	if (src==bConnect || src==miConnect) {
            String s = JOptionPane.showInputDialog("address:port or address","localhost");
    	...
    	//Menu - Hilfe - Über
    		...
    		JOptionPane.showMessageDialog(this,
					...
					"Chatty",JOptionPane.INFORMATION_MESSAGE);
